...
public class TNameUI extends AbstractEndTagSection {
	...
	public TNameUI(XMLEditor textEditor, Composite parentComposite,
			int compositeIndex, int objectIndex, int style,
			Composite container, Object modelParent) throws JAXBException {
		super(textEditor, parentComposite, container, style,
	...
	public void btnUpdateHandleLogic(XMLEditor textEditor) throws JAXBException {
		...
		if (tName.getContent().size() != 0)			tName.getContent().remove(0);
	...
	public void btnRemoveHandleLogic(XMLEditor textEditor) throws JAXBException {
		...
		parentContainer.refreshChildren(HTEditorConstants.NAME_TAG_TITLE,
	...
	public void initialize(XMLEditor textEditor) throws JAXBException {
		if(tName.getLang()!=null)			((Combo) textBoxesList.get(0)).setText(tName.getLang());

		if (tName.getContent().size() != 0)
			((Text) textBoxesList.get(1)).setText(tName.getContent().get(0)
					.toString());
