...
/**
 * The UI class representing the "condition" xml element of type tBoolean-expr in the .ht file
...
public class TBooleanExprUI extends AbstractEndTagSection {
	 ...
	 */
	public TBooleanExprUI(XMLEditor textEditor, Composite parentComposite,
