...
public class TDescriptionUI extends AbstractEndTagSection {
	...
	public void btnUpdateHandleLogic(XMLEditor textEditor) throws JAXBException {
		...
		if (description.getContent().size() != 0)  description.getContent().remove(0);
	...
	public void initialize(XMLEditor textEditor) throws JAXBException {
		if(description.getContentType()!=null)		((Text) textBoxesList.get(0)).setText(description.getContentType());
		if(description.getLang()!=null)						((Combo) textBoxesList.get(1)).setText(description.getLang());
		if(description.getContent().size()!=0)		((Text) textBoxesList.get(2)).setText(description.getContent().get(0).toString());
	}
