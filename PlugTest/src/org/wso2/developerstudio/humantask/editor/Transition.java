 ...
 //   private Section secTestSectionClass_1;
    ...
    public Transition(final XMLEditor editor, final Composite parent, int style) {
        ...
        final Section secLPGS = toolkit.createSection(c2, Section.TWISTIE
                | Section.TITLE_BAR);
        GridData gd_secLPGS = new GridData(SWT.FILL, SWT.CENTER, true, false,
                1, 1);
       ...
       // secTasks.setTitleBarBackground(new Color(getDisplay(), 121,77,171));
        ...
        //scrolledComposite_1.setBackground(SWTResourceManager.getColor(SWT.COLOR_DARK_CYAN));
      ...
      */
        ...
        //secNotifications.setTitleBarBackground(new Color(getDisplay(), 121,77,171));
    ...
    /*    Composite composite = new Composite(composite_SecTASK_SC, SWT.NONE);
        ...
        /*Section sctnNewSection = toolkit.createSection(composite_SecTASK_SC, Section.TITLE_BAR);
        GridData zzzz = new GridData(SWT.FILL, SWT.CENTER,
                false, false, 1, 1);
        zzzz.heightHint = 68;
        zzzz.widthHint = 647;
        sctnNewSection.setLayoutData(zzzz);
       */
        
       /* try {
			 xx=new TTasksUI(editor,composite_SecTASK_SC,here,SWT.NONE,editor.getRootElement().getTasks(),0,0);
