...
public class Transition extends Composite {
	...
	public Transition(final XMLEditor editor,final Composite parent, int style) {
		...
		toolkit.paintBordersFor(this);
				...
				final ScrolledComposite sc2 = new ScrolledComposite(this, SWT.BORDER | SWT.V_SCROLL);
				...
				///////////////////////////////////////////
				 final Section secLPGS = toolkit.createSection(c2, Section.TWISTIE
							| Section.TITLE_BAR);
				 GridData gd_secLPGS = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
				 ...
				 secLPGS.setLayoutData(gd_secLPGS);
					...
					final ScrolledComposite sc_SecLPGS = new ScrolledComposite(
							secLPGS,  SWT.H_SCROLL | SWT.V_SCROLL);
					sc_SecLPGS.setExpandVertical(true);
					sc_SecLPGS.setBackground(SWTResourceManager.getColor(165, 42,
							42));
					...
					//sc_SecLPGS.setMinSize(comp_sc_SecLPGS.computeSize(SWT.DEFAULT, SWT.DEFAULT));
					
					RowLayout rL1=new RowLayout();
					comp_sc_SecLPGS.setLayout(new GridLayout(1, false));
					
				/*	Composite testingTDocElement22=new TLogicalPeopleGroupComposite2(0,comp_sc_SecLPGS, SWT.NONE);
					toolkit.adapt(testingTDocElement22);
					toolkit.paintBordersFor(testingTDocElement22);
					
					
					Composite testingTDocElement11=new TLogicalPeopleGroupComposite2(1,comp_sc_SecLPGS, SWT.NONE);
					toolkit.adapt(testingTDocElement11);
					toolkit.paintBordersFor(testingTDocElement11);
					
					Composite testingTDocElement33=new TLogicalPeopleGroupComposite2(2,comp_sc_SecLPGS, SWT.NONE);
					...
					btnAddLPG.addListener(SWT.Selection, new Listener() {
						...
						public void handleEvent(Event event) {
							LPGArrayList.add(LPGindex,new TLogicalPeopleGroupComposite2(LPGindex,comp_sc_SecLPGS, SWT.NONE));
							System.out.println("button clicked and added LogicalPeopleGroup"+c2.computeSize(SWT.DEFAULT, SWT.DEFAULT));
							sc2.setMinSize(c2.computeSize(SWT.DEFAULT, SWT.DEFAULT).x-30, c2.computeSize(SWT.DEFAULT, SWT.DEFAULT).y+5);
							//c2.layout();
							LPGindex++;
							
							/*Composite testingTDocElement22=new TLogicalPeopleGroupComposite2(0,comp_sc_SecLPGS, SWT.NONE);
							System.out.println("a "+comp_sc_SecLPGS.computeSize(SWT.DEFAULT, SWT.DEFAULT));
							
							Composite testingTDocElement11=new TLogicalPeopleGroupComposite2(1,comp_sc_SecLPGS, SWT.NONE);
							System.out.println("b"+comp_sc_SecLPGS.computeSize(SWT.DEFAULT, SWT.DEFAULT));
							
							Composite testingTDocElement33=new TLogicalPeopleGroupComposite2(2,comp_sc_SecLPGS, SWT.NONE);
							System.out.println("c"+comp_sc_SecLPGS.computeSize(SWT.DEFAULT, SWT.DEFAULT));
							
							System.out.println("is disposed 3rd one:"+testingTDocElement33.isDisposed());*/
						}
					});
				 ...
				 Section secTasks = toolkit.createSection(c2, Section.TWISTIE
						| Section.TITLE_BAR);
				 secTasks.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
				...
				gd_testingTDocElement2.heightHint = 36;
				testingTDocElement2.setLayoutData(gd_testingTDocElement2);
				//testingTDocElement2.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false, 1, 1));
				
				
				Composite testingTDocElement1=new TDocumentationComposite(composite_SecTASK_SC, SWT.NONE);
				GridData gd_testingTDocElement1 = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
				gd_testingTDocElement1.heightHint = 40;
				testingTDocElement1.setLayoutData(gd_testingTDocElement1);*/
				
				
				
				Button btnAddClasscomposite = new Button(secTasks, SWT.NONE);
				toolkit.adapt(btnAddClasscomposite, true, true);
				secTasks.setTextClient(btnAddClasscomposite);
				secTasks.layout();
				btnAddClasscomposite.setText("+");
				btnAddClasscomposite.addListener(SWT.Selection, new Listener() {
				...
				Section secNotifications = toolkit.createSection(c2, Section.TWISTIE
						| Section.TITLE_BAR);
				GridData gd_secNotifications = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
				gd_secNotifications.heightHint = 68;
				gd_secNotifications.widthHint = 647;
				secNotifications.setLayoutData(gd_secNotifications);
				secNotifications.setBackground(SWTResourceManager.getColor(153, 204, 204));
				...
				/*Composite4 compNotifications= new Composite4(editor, secNotifications, SWT.NONE);
				secNotifications.setClient(compNotifications);*/
				
				
				//secTasks.setSize(composite_SecTASK_SC.computeSize(SWT.DEFAULT, SWT.DEFAULT));
				
				//Section secTest=new SectionTest(composite_SecTASK_SC, Section.TWISTIE | Section.TITLE_BAR);
				/*GridData gd_secTest = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
				gd_secTest.heightHint = 73;
				gd_secTest.minimumHeight = 40;
				gd_secTest.widthHint = 617;
				secTest.setLayoutData(gd_secTest);*/
				//secTest.setText("SectionTest Class extended by section");
				//secTest.setTitleBarGradientBackground(new Color(getDisplay(), 200, 10, 12)) ;
				//secTest.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false, 1, 1));
				//try {
				/*Section scc=new TTaskSection(new XMLEditor(), composite_SecTASK_SC,  Section.TWISTIE | Section.TITLE_BAR);
				scc.setExpanded(false);*/
				
			//	Section secTestSectionClass = null;
				
				//	secTestSectionClass_1 = new TTaskInterfaceSection(new XMLEditor(), composite_SecTASK_SC, 1,  Section.TWISTIE | Section.TITLE_BAR);
				
				GridData gd_secTestSectionClass = new GridData(SWT.LEFT, SWT.CENTER, false, false, 1, 1);
				...
				//Section secTestSectionClass2=new TTaskInterfaceSection(editor, composite_SecTASK_SC, 2,  Section.TWISTIE | Section.TITLE_BAR);
			...
			/*	Section sctnNewSection = toolkit.createSection(composite_SecTASK_SC, Section.TWISTIE | Section.TITLE_BAR);
				...
				sctnNewSection.setTitleBarBackground(new Color(getDisplay(), 200, 10, 12)) ;
				sctnNewSection.setExpanded(true);*/
				
				/*Section sct=new SectionCode().getSection(toolkit,composite_SecTASK_SC);
				Section sct2=new SectionCode().getSection(toolkit,composite_SecTASK_SC);*/
			
				
			/*	Button btnNewButton_1 = toolkit.createButton(sctnNewSection, "New Button", SWT.NONE);
				sctnNewSection.setClient(btnNewButton_1);
				secTasks.layout();*/
				...
				btnNewButton.setBounds(10, 0, 91, 29);
				toolkit.adapt(btnNewButton, true, true);
				btnNewButton.setText("Add Task");
				
				
				//Section sc3=new TTaskInterfaceSection2(editor, composite_SecTASK_SC, 1,Section.TWISTIE | Section.TITLE_BAR);
				//sc3.setExpanded(false);
				
				//sc3.setLayoutData(gd_secTestSectionClass);
				
				//Button btnNewButton_1 = toolkit.createButton(composite, "New Button", SWT.NONE);
				...
				btnNewButton.addListener(SWT.Selection, new Listener() {
					...
					public void handleEvent(Event event) {
						...
						Section scc2=new TTaskSection(editor, composite_SecTASK_SC,  Section.TWISTIE | Section.TITLE_BAR);
				...
				/*Section scc4=new TTaskSection(editor, composite_SecTASK_SC,  Section.TWISTIE | Section.TITLE_BAR);
				scc4.setExpanded(false);*/
